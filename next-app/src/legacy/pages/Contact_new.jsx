...
import { Clock, Star, TrendingUp, Award, Shield, Zap, CheckCircle, HelpCircle, AlertTriangle, Phone, CalcIcon as CalculatorIcon, Sun, Battery, BarChart, Leaf, Users, Wrench, ArrowRight, MapPin, X, Mail, Globe, Calendar, PhoneCall, AlertCircle, Cpu } from '@/components/icons';
...
export default function Contact() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 to-white">
      <Helmet>
  <title>Solar Beratung Berlin 2025 – Kostenlos & TÜV DE</title>
  <meta name="description" content="Solar Beratung Berlin 2025: Unverbindlich, TÜV zertifiziert, 15+ Jahre Erfahrung, Rückruf in 2 Stunden – jetzt anfragen & unabhängigen Projektstart sichern." />
        ...
        <div className="grid lg:grid-cols-3 gap-12">
          <div className="lg:col-span-2">
            <Card className="border-none shadow-2xl pro-card">
              ...
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-6" noValidate aria-describedby={Object.keys(errors).length ? 'form-error-summary' : undefined}>
                  ...
                  <div className="space-y-4">
                    ...
                    <div aria-live="polite" className="sr-only" id="form-status-live">
                      {isSubmitting ? 'Formular wird gesendet' : submitted ? 'Formular erfolgreich gesendet' : ''}
                    </div>
