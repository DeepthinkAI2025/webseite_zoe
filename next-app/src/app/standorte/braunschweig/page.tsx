...
export const metadata: Metadata = buildMetadata({
  title: 'Photovoltaik Installation Braunschweig – Planung & Montage',
  ...
  canonicalPath: '/standorte/braunschweig'
});

export default function BraunschweigStandortPage(){
  const usp = [
  ...
  return (
    <main className="mx-auto max-w-5xl px-6 py-12">
      <JsonLd
        id="ld-breadcrumb-standort-braunschweig"
        data={breadcrumbJsonLd([
          { name: 'Start', url: '/' },
          { name: 'Standorte', url: '/standorte' },
          { name: 'Braunschweig', url: '/standorte/braunschweig' }
        ])}
      />
      <JsonLd
        id="ld-servicearea-braunschweig"
        data={cityServiceJsonLd({
          name: localBiz.name,
          url: 'https://www.zoe-solar.de/standorte/braunschweig',
          city: 'Braunschweig',
          country: localBiz.country,
          areaServed: ['Braunschweig','Niedersachsen'],
          lat: 52.268874,
          lon: 10.526769,
          serviceName: 'Photovoltaik Installation Braunschweig',
          serviceDescription: 'Planung, Montage & Speicherlösungen für PV Anlagen in Braunschweig.'
        })}
      />
      <JsonLd
        id="ld-faq-braunschweig"
        data={{
  ...
  <h1 className="text-3xl md:text-4xl font-bold tracking-tight">Photovoltaik Installation Braunschweig</h1>
  <p className="mt-4 text-neutral-600 max-w-2xl mx-auto">Planung → Installation → Monitoring – wirtschaftlich optimiert für regionale Bedingungen.</p>
      ...
      <section className="mt-12"><h2 className="text-xl font-semibold mb-4">Regionale Kennzahlen & Kontext</h2><div className="grid md:grid-cols-2 gap-6 text-sm text-neutral-700"><ul className="space-y-2"><li><strong>Globalstrahlung:</strong> 1095 kWh/m²</li><li><strong>Spezifischer Ertrag:</strong> 900–1015 kWh/kWp</li><li><strong>Speicher Hinweis:</strong> Stabile Grundlast – Speicher 6–8 kWh effizient</li></ul><ul className="space-y-2"><li><strong>Netzanschluss Ablauf:</strong> 5–8 Wochen</li><li><strong>Verschattungsrisiko:</strong> medium</li><li><strong>Dachmix:</strong> Ziegel Steildächer, moderate Gauben</li></ul></div></section>
    </main>
  );
}
