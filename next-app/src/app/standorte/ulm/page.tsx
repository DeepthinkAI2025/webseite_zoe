...
export const metadata: Metadata = buildMetadata({
  title: 'Photovoltaik Installation Ulm – Planung & Montage',
  ...
  canonicalPath: '/standorte/ulm'
});

export default function UlmStandortPage(){
  const usp = [
  ...
  return (
    <main className="mx-auto max-w-5xl px-6 py-12">
      ...
      />
      <JsonLd
        id="ld-servicearea-ulm"
        data={cityServiceJsonLd({
          name: localBiz.name,
          url: 'https://www.zoe-solar.de/standorte/ulm',
          city: 'Ulm',
          country: localBiz.country,
          areaServed: ['Ulm','Baden-Württemberg'],
          lat: 48.401082,
          lon: 9.987608,
          serviceName: 'Photovoltaik Installation Ulm',
          serviceDescription: 'Planung & Installation wirtschaftlich optimierter PV & Speicher Systeme in Ulm.'
        })}
      />
      <JsonLd
        id="ld-faq-ulm"
  ...
  <h1 className="text-3xl md:text-4xl font-bold tracking-tight">Photovoltaik Installation Ulm</h1>
  <p className="mt-4 text-neutral-600 max-w-2xl mx-auto">Planung → Installation → Monitoring – wirtschaftlich optimiert für regionale Bedingungen.</p>
      ...
      <section className="mt-12"><h2 className="text-xl font-semibold mb-4">Weitere Standorte (Region)</h2><ul className="list-disc pl-5 space-y-1 text-sm"><li><a className="text-blue-600 underline" href="/standorte/stuttgart">Photovoltaik Stuttgart</a></li><li><a className="text-blue-600 underline" href="/standorte/mannheim">Photovoltaik Mannheim</a></li><li><a className="text-blue-600 underline" href="/standorte/karlsruhe">Photovoltaik Karlsruhe</a></li></ul></section>
    
      <section className="mt-12"><h2 className="text-xl font-semibold mb-4">Regionale Kennzahlen & Kontext</h2><div className="grid md:grid-cols-2 gap-6 text-sm text-neutral-700"><ul className="space-y-2"><li><strong>Globalstrahlung:</strong> 1170 kWh/m²</li><li><strong>Spezifischer Ertrag:</strong> 940–1065 kWh/kWp</li><li><strong>Speicher Hinweis:</strong> Kombination mit Wärmepumpe verbreitet → Speicher Synergie</li></ul><ul className="space-y-2"><li><strong>Netzanschluss Ablauf:</strong> 4–6 Wochen</li><li><strong>Verschattungsrisiko:</strong> low</li><li><strong>Dachmix:</strong> Viele frei stehende Einfamilienhäuser</li></ul></div></section>
    </main>
  );
}
