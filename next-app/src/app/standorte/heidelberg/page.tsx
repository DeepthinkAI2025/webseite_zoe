...
export const metadata: Metadata = buildMetadata({
  title: 'Photovoltaik Installation Heidelberg – Planung & Montage',
  ...
  canonicalPath: '/standorte/heidelberg'
});

export default function HeidelbergStandortPage(){
  const usp = [
  ...
  return (
    <main className="mx-auto max-w-5xl px-6 py-12">
      <JsonLd
        id="ld-breadcrumb-standort-heidelberg"
        data={breadcrumbJsonLd([
          { name: 'Start', url: '/' },
          { name: 'Standorte', url: '/standorte' },
          { name: 'Heidelberg', url: '/standorte/heidelberg' }
        ])}
      />
      <JsonLd
        id="ld-servicearea-heidelberg"
        data={cityServiceJsonLd({
          name: localBiz.name,
          url: 'https://www.zoe-solar.de/standorte/heidelberg',
          city: 'Heidelberg',
          country: localBiz.country,
          areaServed: ['Heidelberg','Baden-Württemberg'],
          lat: 49.39875,
          lon: 8.672434,
          serviceName: 'Photovoltaik Installation Heidelberg',
          serviceDescription: 'Planung & Installation optimierter PV & Speicher Systeme in Heidelberg.'
        })}
      />
      <JsonLd
        id="ld-faq-heidelberg"
        data={{
  ...
  <h1 className="text-3xl md:text-4xl font-bold tracking-tight">Photovoltaik Installation Heidelberg</h1>
  <p className="mt-4 text-neutral-600 max-w-2xl mx-auto">Planung → Installation → Monitoring – wirtschaftlich optimiert für regionale Bedingungen.</p>
      ...
      <section className="mt-12"><h2 className="text-xl font-semibold mb-4">Regionale Kennzahlen & Kontext</h2><div className="grid md:grid-cols-2 gap-6 text-sm text-neutral-700"><ul className="space-y-2"><li><strong>Globalstrahlung:</strong> 1180 kWh/m²</li><li><strong>Spezifischer Ertrag:</strong> 945–1070 kWh/kWp</li><li><strong>Speicher Hinweis:</strong> Akademische Nutzung + EV-Adoption → Speicher 7–9 kWh</li></ul><ul className="space-y-2"><li><strong>Netzanschluss Ablauf:</strong> 4–6 Wochen</li><li><strong>Verschattungsrisiko:</strong> medium</li><li><strong>Dachmix:</strong> Altbau + Forschungseinrichtungen, unterschiedliche Neigungen</li></ul></div></section>
    </main>
  );
}
