...
export const metadata: Metadata = buildMetadata({
  title: 'Photovoltaik Installation Bielefeld – Planung & Montage',
  ...
  canonicalPath: '/standorte/bielefeld'
});

export default function BielefeldStandortPage(){
  const usp = [
  ...
  return (
    <main className="mx-auto max-w-5xl px-6 py-12">
      <JsonLd
        id="ld-breadcrumb-standort-bielefeld"
        data={breadcrumbJsonLd([
          { name: 'Start', url: '/' },
          { name: 'Standorte', url: '/standorte' },
          { name: 'Bielefeld', url: '/standorte/bielefeld' }
        ])}
      />
      <JsonLd
        id="ld-servicearea-bielefeld"
        data={cityServiceJsonLd({
          name: localBiz.name,
          url: 'https://www.zoe-solar.de/standorte/bielefeld',
          city: 'Bielefeld',
          country: localBiz.country,
          areaServed: ['Bielefeld','Nordrhein-Westfalen'],
          lat: 52.030228,
          lon: 8.532471,
          serviceName: 'Photovoltaik Installation Bielefeld',
          serviceDescription: 'PV Planung & Installation in Bielefeld und Umgebung.'
        })}
      />
      <JsonLd
        id="ld-faq-bielefeld"
  ...
  <h1 className="text-3xl md:text-4xl font-bold tracking-tight">Photovoltaik Installation Bielefeld</h1>
  <p className="mt-4 text-neutral-600 max-w-2xl mx-auto">Planung → Installation → Monitoring – wirtschaftlich optimiert für regionale Bedingungen.</p>
      ...
      <section className="mt-12"><h2 className="text-xl font-semibold mb-4">Regionale Kennzahlen & Kontext</h2><div className="grid md:grid-cols-2 gap-6 text-sm text-neutral-700"><ul className="space-y-2"><li><strong>Globalstrahlung:</strong> 1085 kWh/m²</li><li><strong>Spezifischer Ertrag:</strong> 890–1005 kWh/kWp</li><li><strong>Speicher Hinweis:</strong> Pendlerprofile → Speicher 6–8 kWh für Abendlast</li></ul><ul className="space-y-2"><li><strong>Netzanschluss Ablauf:</strong> 6–9 Wochen</li><li><strong>Verschattungsrisiko:</strong> medium</li><li><strong>Dachmix:</strong> Reihenhäuser + einzelne Verschattungen durch Bäume</li></ul></div></section>
    </main>
  );
}
