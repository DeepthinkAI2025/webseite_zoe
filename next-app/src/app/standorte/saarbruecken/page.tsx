...
export const metadata: Metadata = buildMetadata({
  title: 'Photovoltaik Installation Saarbrücken – Planung & Montage',
  ...
  canonicalPath: '/standorte/saarbruecken'
});

export default function SaarbrckenStandortPage(){
  const usp = [
  ...
  return (
    <main className="mx-auto max-w-5xl px-6 py-12">
      <JsonLd
        id="ld-breadcrumb-standort-saarbruecken"
        data={breadcrumbJsonLd([
          { name: 'Start', url: '/' },
          { name: 'Standorte', url: '/standorte' },
          { name: 'Saarbrücken', url: '/standorte/saarbruecken' }
        ])}
      />
      <JsonLd
        id="ld-servicearea-saarbruecken"
        data={cityServiceJsonLd({
          name: localBiz.name,
          url: 'https://www.zoe-solar.de/standorte/saarbruecken',
          city: 'Saarbrücken',
          country: localBiz.country,
          areaServed: ['Saarbrücken','Saarland'],
          lat: 49.240157,
          lon: 6.996933,
          serviceName: 'Photovoltaik Installation Saarbrücken',
          serviceDescription: 'PV, Speicher & Monitoring Lösungen für Saarbrücken.'
        })}
      />
      <JsonLd
        id="ld-faq-saarbruecken"
        data={{
  ...
  <h1 className="text-3xl md:text-4xl font-bold tracking-tight">Photovoltaik Installation Saarbrücken</h1>
  <p className="mt-4 text-neutral-600 max-w-2xl mx-auto">Planung → Installation → Monitoring – wirtschaftlich optimiert für regionale Bedingungen.</p>
      ...
      <section className="mt-12"><h2 className="text-xl font-semibold mb-4">Regionale Kennzahlen & Kontext</h2><div className="grid md:grid-cols-2 gap-6 text-sm text-neutral-700"><ul className="space-y-2"><li><strong>Globalstrahlung:</strong> 1150 kWh/m²</li><li><strong>Spezifischer Ertrag:</strong> 930–1050 kWh/kWp</li><li><strong>Speicher Hinweis:</strong> Grenznähe diffuses Licht – Speicher erhöht Eigenverbrauch</li></ul><ul className="space-y-2"><li><strong>Netzanschluss Ablauf:</strong> 5–8 Wochen</li><li><strong>Verschattungsrisiko:</strong> medium</li><li><strong>Dachmix:</strong> Gemischte Dachtypen, teils Verschattung durch Bäume</li></ul></div></section>
    </main>
  );
}
