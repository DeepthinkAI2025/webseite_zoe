...
export const metadata: Metadata = buildMetadata({
  title: 'Photovoltaik Installation Regensburg – Planung & Montage',
  ...
  canonicalPath: '/standorte/regensburg'
});

export default function RegensburgStandortPage(){
  const usp = [
  ...
  return (
    <main className="mx-auto max-w-5xl px-6 py-12">
      <JsonLd
        id="ld-breadcrumb-standort-regensburg"
        data={breadcrumbJsonLd([
          { name: 'Start', url: '/' },
          { name: 'Standorte', url: '/standorte' },
          { name: 'Regensburg', url: '/standorte/regensburg' }
        ])}
      />
      <JsonLd
        id="ld-servicearea-regensburg"
        data={cityServiceJsonLd({
          name: localBiz.name,
          url: 'https://www.zoe-solar.de/standorte/regensburg',
          city: 'Regensburg',
          country: localBiz.country,
          areaServed: ['Regensburg','Bayern'],
          lat: 49.013432,
          lon: 12.101624,
          serviceName: 'Photovoltaik Installation Regensburg',
          serviceDescription: 'Photovoltaik & Speicher Umsetzung in Regensburg.'
        })}
      />
      <JsonLd
        id="ld-faq-regensburg"
        data={{
  ...
  <h1 className="text-3xl md:text-4xl font-bold tracking-tight">Photovoltaik Installation Regensburg</h1>
  <p className="mt-4 text-neutral-600 max-w-2xl mx-auto">Planung → Installation → Monitoring – wirtschaftlich optimiert für regionale Bedingungen.</p>
      ...
      <section className="mt-12"><h2 className="text-xl font-semibold mb-4">Weitere Standorte (Region)</h2><ul className="list-disc pl-5 space-y-1 text-sm"><li><a className="text-blue-600 underline" href="/standorte/muenchen">Photovoltaik Muenchen</a></li><li><a className="text-blue-600 underline" href="/standorte/ingolstadt">Photovoltaik Ingolstadt</a></li><li><a className="text-blue-600 underline" href="/standorte/wuerzburg">Photovoltaik Wuerzburg</a></li></ul></section>
    
      <section className="mt-12"><h2 className="text-xl font-semibold mb-4">Regionale Kennzahlen & Kontext</h2><div className="grid md:grid-cols-2 gap-6 text-sm text-neutral-700"><ul className="space-y-2"><li><strong>Globalstrahlung:</strong> 1175 kWh/m²</li><li><strong>Spezifischer Ertrag:</strong> 940–1075 kWh/kWp</li><li><strong>Speicher Hinweis:</strong> Konstante Einstrahlung – 7–9 kWh Speicher sinnvoll</li></ul><ul className="space-y-2"><li><strong>Netzanschluss Ablauf:</strong> 4–6 Wochen</li><li><strong>Verschattungsrisiko:</strong> low</li><li><strong>Dachmix:</strong> Historische Dächer + Neubau Mischstruktur</li></ul></div></section>
    </main>
  );
}
