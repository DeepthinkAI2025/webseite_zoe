...
export const metadata: Metadata = buildMetadata({
  title: 'Photovoltaik Installation Ingolstadt – Planung & Montage',
  ...
  canonicalPath: '/standorte/ingolstadt'
});

export default function IngolstadtStandortPage(){
  const usp = [
  ...
  return (
    <main className="mx-auto max-w-5xl px-6 py-12">
      <JsonLd
        id="ld-breadcrumb-standort-ingolstadt"
        data={breadcrumbJsonLd([
          { name: 'Start', url: '/' },
          { name: 'Standorte', url: '/standorte' },
          { name: 'Ingolstadt', url: '/standorte/ingolstadt' }
        ])}
      />
      <JsonLd
        id="ld-servicearea-ingolstadt"
        data={cityServiceJsonLd({
          name: localBiz.name,
          url: 'https://www.zoe-solar.de/standorte/ingolstadt',
          city: 'Ingolstadt',
          country: localBiz.country,
          areaServed: ['Ingolstadt','Bayern'],
          lat: 48.766535,
          lon: 11.425754,
          serviceName: 'Photovoltaik Installation Ingolstadt',
          serviceDescription: 'Regionale PV & Speicher Umsetzung in Ingolstadt – wirtschaftlich & skalierbar.'
        })}
      />
      <JsonLd
        id="ld-faq-ingolstadt"
        data={{
  ...
  <h1 className="text-3xl md:text-4xl font-bold tracking-tight">Photovoltaik Installation Ingolstadt</h1>
  <p className="mt-4 text-neutral-600 max-w-2xl mx-auto">Planung → Installation → Monitoring – wirtschaftlich optimiert für regionale Bedingungen.</p>
      ...
      <section className="mt-12"><h2 className="text-xl font-semibold mb-4">Weitere Standorte (Region)</h2><ul className="list-disc pl-5 space-y-1 text-sm"><li><a className="text-blue-600 underline" href="/standorte/muenchen">Photovoltaik Muenchen</a></li><li><a className="text-blue-600 underline" href="/standorte/regensburg">Photovoltaik Regensburg</a></li><li><a className="text-blue-600 underline" href="/standorte/augsburg">Photovoltaik Augsburg</a></li></ul></section>
    
      <section className="mt-12"><h2 className="text-xl font-semibold mb-4">Regionale Kennzahlen & Kontext</h2><div className="grid md:grid-cols-2 gap-6 text-sm text-neutral-700"><ul className="space-y-2"><li><strong>Globalstrahlung:</strong> 1185 kWh/m²</li><li><strong>Spezifischer Ertrag:</strong> 945–1085 kWh/kWp</li><li><strong>Speicher Hinweis:</strong> Industrie/Automotive Lastprofile → Speicher Lastverschiebung</li></ul><ul className="space-y-2"><li><strong>Netzanschluss Ablauf:</strong> 4–6 Wochen</li><li><strong>Verschattungsrisiko:</strong> low</li><li><strong>Dachmix:</strong> Gewerbe Flachdächer + Wohnsteildächer</li></ul></div></section>
    </main>
  );
}
