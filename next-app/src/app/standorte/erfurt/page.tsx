...
export const metadata: Metadata = buildMetadata({
  title: 'Photovoltaik Installation Erfurt – Planung & Montage',
  ...
  canonicalPath: '/standorte/erfurt'
});

export default function ErfurtStandortPage(){
  const usp = [
  ...
  return (
    <main className="mx-auto max-w-5xl px-6 py-12">
      <JsonLd
        id="ld-breadcrumb-standort-erfurt"
        data={breadcrumbJsonLd([
          { name: 'Start', url: '/' },
          { name: 'Standorte', url: '/standorte' },
          { name: 'Erfurt', url: '/standorte/erfurt' }
        ])}
      />
      <JsonLd
        id="ld-servicearea-erfurt"
        data={cityServiceJsonLd({
          name: localBiz.name,
          url: 'https://www.zoe-solar.de/standorte/erfurt',
          city: 'Erfurt',
          country: localBiz.country,
          areaServed: ['Erfurt','Thüringen'],
          lat: 50.977708,
          lon: 11.02872,
          serviceName: 'Photovoltaik Installation Erfurt',
          serviceDescription: 'PV Planung & Installation in Erfurt und Thüringen.'
        })}
      />
      <JsonLd
        id="ld-faq-erfurt"
  ...
  <h1 className="text-3xl md:text-4xl font-bold tracking-tight">Photovoltaik Installation Erfurt</h1>
  <p className="mt-4 text-neutral-600 max-w-2xl mx-auto">Planung → Installation → Monitoring – wirtschaftlich optimiert für regionale Bedingungen.</p>
      ...
      <section className="mt-12"><h2 className="text-xl font-semibold mb-4">Regionale Kennzahlen & Kontext</h2><div className="grid md:grid-cols-2 gap-6 text-sm text-neutral-700"><ul className="space-y-2"><li><strong>Globalstrahlung:</strong> 1125 kWh/m²</li><li><strong>Spezifischer Ertrag:</strong> 905–1020 kWh/kWp</li><li><strong>Speicher Hinweis:</strong> Kontinentale Temperaturspannen – Speicher balanciert Winter/Über-gang</li></ul><ul className="space-y-2"><li><strong>Netzanschluss Ablauf:</strong> 5–8 Wochen</li><li><strong>Verschattungsrisiko:</strong> medium</li><li><strong>Dachmix:</strong> Mischung Sattel-/Walmdächer, teils Verschattung</li></ul></div></section>
    </main>
  );
}
