...
export const metadata: Metadata = buildMetadata({
  title: 'Photovoltaik Installation Würzburg – Planung & Montage',
  ...
  canonicalPath: '/standorte/wuerzburg'
});

export default function WrzburgStandortPage(){
  const usp = [
  ...
  return (
    <main className="mx-auto max-w-5xl px-6 py-12">
      <JsonLd
        id="ld-breadcrumb-standort-wuerzburg"
        data={breadcrumbJsonLd([
          { name: 'Start', url: '/' },
          { name: 'Standorte', url: '/standorte' },
          { name: 'Würzburg', url: '/standorte/wuerzburg' }
        ])}
      />
      <JsonLd
        id="ld-servicearea-wuerzburg"
        data={cityServiceJsonLd({
          name: localBiz.name,
          url: 'https://www.zoe-solar.de/standorte/wuerzburg',
          city: 'Würzburg',
          country: localBiz.country,
          areaServed: ['Würzburg','Bayern'],
          lat: 49.791304,
          lon: 9.953355,
          serviceName: 'Photovoltaik Installation Würzburg',
          serviceDescription: 'Regionale PV & Speicher Umsetzung in Würzburg.'
        })}
      />
      <JsonLd
        id="ld-faq-wuerzburg"
  ...
  <h1 className="text-3xl md:text-4xl font-bold tracking-tight">Photovoltaik Installation Würzburg</h1>
  <p className="mt-4 text-neutral-600 max-w-2xl mx-auto">Planung → Installation → Monitoring – wirtschaftlich optimiert für regionale Bedingungen.</p>
      ...
      <section className="mt-12"><h2 className="text-xl font-semibold mb-4">Regionale Kennzahlen & Kontext</h2><div className="grid md:grid-cols-2 gap-6 text-sm text-neutral-700"><ul className="space-y-2"><li><strong>Globalstrahlung:</strong> 1165 kWh/m²</li><li><strong>Spezifischer Ertrag:</strong> 935–1065 kWh/kWp</li><li><strong>Speicher Hinweis:</strong> Weinberge & Reflexion – moderat höherer spezifischer Ertrag</li></ul><ul className="space-y-2"><li><strong>Netzanschluss Ablauf:</strong> 4–6 Wochen</li><li><strong>Verschattungsrisiko:</strong> low</li><li><strong>Dachmix:</strong> Steildächer mit klaren Südfeldern</li></ul></div></section>
    </main>
  );
}
