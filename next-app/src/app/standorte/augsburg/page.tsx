...
export const metadata: Metadata = buildMetadata({
  title: 'Photovoltaik Installation Augsburg – Planung & Montage',
  ...
  canonicalPath: '/standorte/augsburg'
});

export default function AugsburgStandortPage(){
  const usp = [
  ...
  return (
    <main className="mx-auto max-w-5xl px-6 py-12">
      <JsonLd
        id="ld-breadcrumb-standort-augsburg"
      ...
      />
      <JsonLd
        id="ld-servicearea-augsburg"
        data={cityServiceJsonLd({
          name: localBiz.name,
          url: 'https://www.zoe-solar.de/standorte/augsburg',
          city: 'Augsburg',
          country: localBiz.country,
          areaServed: ['Augsburg','Bayern'],
          lat: 48.370545,
          lon: 10.89779,
          serviceName: 'Photovoltaik Installation Augsburg',
          serviceDescription: 'Planung & Installation effizienter PV & Speicher Systeme in Augsburg.'
        })}
      />
      <JsonLd
        id="ld-faq-augsburg"
  ...
  <h1 className="text-3xl md:text-4xl font-bold tracking-tight">Photovoltaik Installation Augsburg</h1>
  <p className="mt-4 text-neutral-600 max-w-2xl mx-auto">Planung → Installation → Monitoring – wirtschaftlich optimiert für regionale Bedingungen.</p>
      ...
      <section className="mt-12"><h2 className="text-xl font-semibold mb-4">Weitere Standorte (Region)</h2><ul className="list-disc pl-5 space-y-1 text-sm"><li><a className="text-blue-600 underline" href="/standorte/muenchen">Photovoltaik Muenchen</a></li><li><a className="text-blue-600 underline" href="/standorte/ingolstadt">Photovoltaik Ingolstadt</a></li><li><a className="text-blue-600 underline" href="/standorte/regensburg">Photovoltaik Regensburg</a></li></ul></section>
    
  <section className="mt-12"><h2 className="text-xl font-semibold mb-4">Regionale Kennzahlen & Kontext</h2><div className="grid md:grid-cols-2 gap-6 text-sm text-neutral-700"><ul className="space-y-2"><li><strong>Globalstrahlung:</strong> 1195 kWh/m²</li><li><strong>Spezifischer Ertrag:</strong> 950–1090 kWh/kWp</li><li><strong>Speicher Hinweis:</strong> Hohe Einstrahlung – Speicher erhöht Eigenverbrauch {'>'}55%</li></ul><ul className="space-y-2"><li><strong>Netzanschluss Ablauf:</strong> 4–6 Wochen</li><li><strong>Verschattungsrisiko:</strong> low</li><li><strong>Dachmix:</strong> Viele gut ausgerichtete Steildächer</li></ul></div></section>
    </main>
  );
}
