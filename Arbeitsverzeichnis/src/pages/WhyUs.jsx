...
export default function WhyUs() {
  ...
  return (
    <div className="bg-white">
      <Helmet>
        <title>{t('seo.home.title')} - Warum ZOE Solar</title>
        ...
        <meta name="twitter:description" content={t('seo.home.desc')} />
      </Helmet>
        ...
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="mt-12 bg-red-50 border border-red-200 rounded-2xl p-8 max-w-4xl mx-auto">
            <div className="flex items-center justify-center mb-4">
              ...
              <h3 className="text-2xl font-bold text-red-800">{t('psychology.rising_costs_title')}</h3>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6 text-center">
              <div className="bg-white rounded-lg p-4 shadow-sm">
                ...
                <div className="text-sm text-gray-600">Strompreise seit 2021</div>
              </div>
              <div className="bg-white rounded-lg p-4 shadow-sm">
                <div className="text-3xl font-bold text-red-600">+€800</div>
                <div className="text-sm text-gray-600">Mehrkosten pro Jahr</div>
              </div>
              <div className="bg-white rounded-lg p-4 shadow-sm">
                <div className="text-3xl font-bold text-red-600">∞</div>
                <div className="text-sm text-gray-600">Für immer ohne Solar</div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex items-center justify-center space-x-4">
              ...
              <div className="text-left">
                <div className="font-semibold text-gray-800">{t('psychology.expert_name')}</div>
                <div className="text-sm text-gray-600">{t('psychology.expert_title')}</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="content-lg">
              <h2 className="text-4xl font-extrabold text-gray-800 tracking-tight">Transparenz von Anfang an.</h2>
              ...
              <div className="mt-8 bg-emerald-50 border border-emerald-200 rounded-xl p-6">
                <h4 className="text-lg font-semibold text-emerald-800 mb-2">{t('hero.reciprocity_title')}</h4>
              ...
              <Card className="shadow-2xl pro-card">
                <CardContent className="p-8">
                  ...
                  <div className="mt-6 space-y-2">
                    <div className="flex justify-between"><span className="text-gray-600">Anschaffungskosten:</span><span className="font-bold">18.500€</span></div>
                    <div className="flex justify-between"><span className="text-gray-600">Staatl. Förderung:</span><span className="font-bold text-red-600">- 4.200€</span></div>
                    <div className="flex justify-between text-lg border-t pt-2 mt-2"><span className="font-bold text-gray-800">Effektive Kosten:</span><span className="font-bold text-emerald-600">14.300€</span></div>
                    <div className="flex justify-between"><span className="text-gray-600">Ersparnis pro Jahr:</span><span className="font-bold">~ 2.200€</span></div>
                    <div className="flex justify-between"><span className="text-gray-600">Amortisation nach:</span><span className="font-bold">~ 6.5 Jahren</span></div>
                  </div>
                </CardContent>
              </Card>
            </div>
      ...
      <section className="bg-gray-50 py-24">
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-extrabold text-gray-800 tracking-tight">{t('psychology.testimonials_title')}</h2>
            <p className="mt-4 text-xl text-gray-600">{t('psychology.testimonials_subtitle')}</p>
          </div>
              ...
              <Card key={index} className="shadow-lg hover:shadow-xl transition-shadow pro-card">
                <CardContent className="p-6">
                  ...
                  <div className="flex items-center mb-4">
                    ...
                    <span className="ml-2 text-sm text-gray-600">• {testimonial.savings}</span>
                  </div>
        ...
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8 text-center">
            <div>
              ...
              <div className="text-emerald-100">Zufriedene Kunden</div>
            </div>
            <div>
              <div className="text-4xl font-bold mb-2">4.9/5</div>
              <div className="text-emerald-100">Durchschnittliche Bewertung</div>
            </div>
            <div>
              <div className="text-4xl font-bold mb-2">€50M+</div>
              <div className="text-emerald-100">Gesparte Stromkosten</div>
            </div>
            <div>
              <div className="text-4xl font-bold mb-2">10+</div>
              <div className="text-emerald-100">Jahre Erfahrung</div>
            </div>
          </div>
        </div>
      </section>
