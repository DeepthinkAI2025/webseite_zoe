...
export const metadata: Metadata = buildMetadata({
  title: 'Photovoltaik Installation Karlsruhe – Planung & Montage',
  ...
  canonicalPath: '/standorte/karlsruhe'
});

export default function KarlsruheStandortPage(){
  const usp = [
  ...
  return (
    <main className="mx-auto max-w-5xl px-6 py-12">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(breadcrumbJsonLd([
        ...
        { name: 'Karlsruhe', url: '/standorte/karlsruhe' }
      ])) }} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(localBusinessJsonLd({
        name: localBiz.name,
        url: 'https://www.zoe-solar.de/standorte/karlsruhe',
  ...
  <h1 className="text-3xl md:text-4xl font-bold tracking-tight">Photovoltaik Installation Karlsruhe</h1>
